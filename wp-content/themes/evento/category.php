...
<div class="b_content clearfix" id="main">
    ...
    <div class="b_page clearfix">
        <div id="content">
            <div class="b w_940">
                <h2 class="page-title category"><?php _e( 'category archives: ' , 'cosmotheme' ); echo get_cat_name( get_query_var('cat') ); ?></h2>
            </div>

            <!-- left sidebar -->
            <?php layout::get_side( 'left' , 0 , 'category' ); ?>

            <div class="b w_<?php echo layout::get_length( 0 , 'category' ); ?> category">
                <?php 
                    if( have_posts() ){
						$k = 0;  	
                        while( have_posts()){
        ...
        <?php
            if( isset( $p404 ) && $p404 ){
                ...
                layout::get_side( 'right' , 0 , 'category' );
            }
        ?>
