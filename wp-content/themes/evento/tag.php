...
<div class="b_content clearfix" id="main">
    ...
    <div class="b_page clearfix">
        <div id="content">
            <div class="b w_940">
                <h2 class="page-title tag"><?php _e( 'tags archives: ' , 'cosmotheme' );  echo get_query_var('tag'); ?></h2>
            </div>

            <!-- left sidebar -->
            <?php layout::get_side( 'left' , 0 , 'tag' ); ?>

            <div class="b w_<?php echo layout::get_length( 0 , 'tag' ); ?> category">
                <?php
                    if( have_posts() ){
						$k = 0;  
                        while( have_posts()){
