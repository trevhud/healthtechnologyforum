    ...
    <div class="b_page clearfix">
        <div id="content">
            ...
            ?>
                        ...
                        <!-- left sidebar -->
                        <?php layout::get_side( 'left' , $post_id , 'exhibitor' ); ?>

                        <!-- content -->
                        <div class="b w_<?php echo layout::get_length( $post_id , 'exhibitor' ); ?>">
        ...
        <?php
            if( isset( $p404 ) && $p404 ){
                ...
                layout::get_side( 'right' , $post_id , 'exhibitor' );
            }
        ?>
    </div>
</div>
