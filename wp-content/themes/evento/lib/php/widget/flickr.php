...
class widget_flickr extends WP_Widget {
	function widget_flickr() {
        ...
        /* Constructor */
		$widget_ops = array('classname' => 'widget Flickr Photos ', 'description' => __( 'Flickr Photos' , 'cosmotheme' ) );
		$this->WP_Widget('widget_flickrwidget', _TN_ . ' : ' . __( 'Flickr Photos' , 'cosmotheme' ), $widget_ops);
	}
