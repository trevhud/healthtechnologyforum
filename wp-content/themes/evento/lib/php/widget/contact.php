<?php
    class widget_contact extends WP_Widget {
        function widget_contact() {
            $widget_ops = array( 'classname' => 'quick-contact', 'description' => __('Display Contact form' , 'cosmotheme' ) );
            parent::WP_Widget( false , _TN_ . ' : ' . __( 'Quick Contact form' , 'cosmotheme' )  , $widget_ops );
