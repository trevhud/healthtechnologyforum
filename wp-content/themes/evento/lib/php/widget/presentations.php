<?php
    class widget_presentations extends WP_Widget{
        function widget_presentations() {
            $options = array( 'classname' => 'presentations', 'description' => __('Display list of Presentations from a Conference' , 'cosmotheme' ) );
            parent::WP_Widget( false , _TN_ . ' : ' . __( 'Conference Presentations' , 'cosmotheme' )  , $options );
        ...
        function form($instance) {
            ...
            if( isset($instance['title']) ){
                ...
                $title = __( 'Conference presentations' , 'cosmotheme' );
            }
		...
		<p>
			...
			<select class="widefat" id="<?php echo $this->get_field_id('category');?>" name="<?php echo $this->get_field_name('category');?>">
				...
				<?php
					$terms=get_terms( options::get_taxonomy( 'presentation' , 'category' ) );
        ...
        <!-- field for set limit  -->
        <p>
          <label for="<?php echo $this -> get_field_id('nr'); ?>"><?php _e( 'Number of presentations to display' , 'cosmotheme' ); ?>:</label>
        ...
        function widget($args, $instance) {
            ...
            if( (int) $conf_id > 0 ){
                ...
                echo conference::presentations( $conf_id , $nr, $category );
                /* read more link */
                if( (int) $page_id > 0 ){
