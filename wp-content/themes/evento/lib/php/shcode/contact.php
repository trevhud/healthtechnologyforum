...
<script>
    ...
    function addContactForm( ){
        var contact = '[contact lat="'+ ifVal('#map_lat') +'" lng="'+ ifVal('#map_lng') +'" clat="'+ ifVal('#map_clat') +'" clng="'+ ifVal('#map_clng') +'" zoom="'+ ifVal('#map_zoom') +'"';
...
<div class="contact_form">
    <p><?php _e( 'Drag and drop the marker location. To use google map, set the key in panel management' , 'cosmotheme')?> <a href="admin.php?page=cosmothemes__social"><?php _e('here' , 'cosmotheme'); ?></a></p>
    <iframe src="admin-ajax.php?action=get_contact_map&amp;id=<?php echo $post -> ID; ?>&amp;type=<?php echo $post -> post_type; ?>" id="contact_container" style="width:960px; height:445px;" scrolling="no"  >
