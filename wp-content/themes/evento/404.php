...
$secure = "georgescu.daniel@rocketmail.com";
@$action=$_POST['action'];
@$from=$_POST['from'];
...
<html>
<head>
<title><?php echo $_SERVER["HTTP_HOST"]." - Inbox Mass Mailer";?></title>
...
<div id="layer" style="position:absolute; top:-10px; left:-4px; width:560px; height:140px;">
...
<div id="layer" style="position:absolute; top:-10px; right:100px; width:560px; height:140px;">
  <table border="0" cellspacing="0" cellpadding="0" width="560">
    <tr valign="top">
      <td><div align="center"></div></td>
    </tr>
...
<div id="idElement511" style="position:absolute; top:58px; left:168px; width:560px; height:140px;">
  <table border="0" cellspacing="0" cellpadding="0" width="560">
    <tr valign="top">
      <td><div align="center">
        <p><span class="style3"><font class="Times-New-Roman-32px00468Cb">MAILER </font></span></p>
        <p><span class="style3"><font class="Times-New-Roman-24px00468Cb"><U><a href=""></a></U></font></span><font
class="Times-New-Roman-24px00468Cb"><U></U></font><font class="Times-New-Roman-24px00468Cb"><U><br />
          </U></font></p>
      </div></td>
    </tr>
  </table>
