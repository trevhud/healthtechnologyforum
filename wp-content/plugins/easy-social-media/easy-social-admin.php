<?php 
	if($_POST['easy_social_hidden'] == 'Y') {
		...
		$rss = $_POST['easy_social_rss'];
		update_option('easy_social_rss', $rss);
		...
		$rss = get_option('easy_social_rss');
	}
...
<form name="easy_social_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
	...
	<p><?php _e("RSS Feed: " ); ?><input type="text" name="easy_social_rss" value="<?php echo $rss; ?>" size="40"></p>
